...
const Skill = () => {
  ...
  const brewser = [
    { title: "Google Chrome", icon: <FaChrome className="" /> },
    { title: "Mozilla Firefox", icon: <BsBrowserFirefox className="text-blue-500" /> },
  ...
  return (
    <div className="  py-20 px-20 bg-[#141414]">
      <h1 className="text-4xl text-white font-semibold drop-shadow-md text-center mb-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-evenly my-8">
        ...
        <div>
          <Lottie className='bg-black' options={defaultOptions} height={400} width={360} />
        </div>
      </div>
    </div>
  );
